...
const generateChartData = (days, maxVal = 50) => {
  const data = [];
...
export const Component = ({
  ...
  return (
    <div
      ...
      <div className="flex w-full pl-8 pr-8 justify-between pb-2 pt-8">
        <div className="flex flex-col gap-2 w-1/2">
          ...
          <div className="flex items-center gap-2">
            <Count className="font-mono text-4xl font-semibold" to={321} />
            <div
              className={cn(
        ...
        <div className="flex flex-col gap-2 w-1/2">
          ...
          <div className="flex items-center gap-2">
            <Count className="font-mono text-4xl font-semibold" to={1120} />
            <div
              className={cn(
                "flex p-1 pl-2 pr-2 items-center rounded-full",
                totalBgOpacity,
      ...
      <div
        className="flex flex-col pl-8 pr-8 font-mono divide-y divide-gray-200 dark:divide-[#262631]">
        {[
          ...
          <motion.div
            ...
            <div
              className="flex flex-row gap-2 items-center text-base w-1/2 text-gray-600 dark:text-[#9A9AAF]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
